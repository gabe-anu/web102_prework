...
function addGamesToPage(games) {
    ...
    // create a for loop over each item in the data
...
// create a new element to hold the name of the top pledge game, then append it to the correct
...
secondGameElement.innerText = `Runner Up: ${secondGame.name}`;
